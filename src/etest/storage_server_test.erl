...
%   <<"value one">> = storage_server:get(store2, "key_one"),
%   true = storage_server:has_key(store2, "key_one"),
%   storage_server:delete(store2, "key_one"),
%   false = storage_server:has_key(store2, "key_one"),
%   true = storage_server:has_key(store2, "key_two"),
